...
const AddHabit = ()=> {
    ...
    const initalHabits = JSON.parse(localStorage.getItem('habits')) || [];

    const [habits, setHabits] = useState(initalHabits);
    ...
    const handleSubmit = (e)=> {
        ...
        if(editIndex !== null){
            ...
            updateHabits[editIndex].name = habit;
            updateHabits[editIndex].description = description;
